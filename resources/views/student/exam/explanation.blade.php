        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <template x-if="!allQuestions || allQuestions.length === 0">
                <div class="flex-1 flex flex-col items-center justify-center text-center bg-white p-8">
                    ...
                    <p class="text-xs text-slate-450 mt-1 max-w-xs leading-relaxed">Belum ada soal tryout yang ditambahkan
                        pada subtest yang telah diselesaikan.</p>
                    <a href="{{ route('student.exam.results', $examResult) }}"
                        class="mt-6 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-bold uppercase tracking-wider shadow-sm">Kembali
                        ke Hasil</a>
                </div>
            </template>
                        ...
                        <div class="max-w-3xl mx-auto space-y-8 pb-24">
                                            ...
                                            <div class="relative flex items-center p-3.5 rounded-xl border transition-all"
                                                ...
                                                <div class="absolute -right-2 -top-2 flex gap-1 z-10">
                                                    <span x-show="option.is_correct"
                                                        class="px-2 py-0.5 bg-emerald-600 text-white text-[8px] font-bold uppercase rounded-md shadow-xs">Kunci
                                                        Jawaban</span>
                                                    <span x-show="userChoiceId == option.id"
                                                        class="px-2 py-0.5 text-white text-[8px] font-bold uppercase rounded-md shadow-xs"
                                                        :class="option.is_correct ? 'bg-blue-600' : 'bg-rose-600'">Jawaban
                                                        Anda</span>
                                                </div>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <template x-if="selectedOptionIds.map(Number).includes(option.id)">
                                                        <span
                                                            ...
                                                            :class="option.is_correct ? 'bg-blue-600' : 'bg-rose-600'">Pilihan
                                                            Anda</span>
                                                    </template>
                                                </div>
                                            </div>
                                        ...
                                        <table class="w-full text-left border-collapse">
                                            <thead>
                                                <tr class="bg-slate-50 border-b border-slate-200">
                                                    <th
                                                        class="px-5 py-3 text-[9px] font-bold text-slate-500 uppercase tracking-wider">
                                                        Item Pertanyaan</th>
                                                    <th
                                                        class="px-5 py-3 text-[9px] font-bold text-slate-500 uppercase tracking-wider">
                                                        Pilihan Anda</th>
                                ...
                                <template x-if="currentQuestion && currentQuestion.type === 'benar_salah'">
                                    <div class="overflow-hidden border border-slate-200 rounded-xl bg-white shadow-xs">
                                        <table class="w-full text-left border-collapse">
                                            <thead>
                                                <tr class="bg-slate-50 border-b border-slate-200">
                                                    <th class="px-5 py-3 text-[9px] font-bold text-slate-550 uppercase tracking-wider">Pernyataan</th>
                                                    <th class="px-5 py-3 text-[9px] font-bold text-slate-550 uppercase tracking-wider">Pilihan Anda</th>
                                                    <th class="px-5 py-3 text-[9px] font-bold text-slate-550 uppercase tracking-wider">Kunci Jawaban</th>
                            ...
                            <div class="pl-12 scroll-mt-20" id="explanation-box" x-show="currentQuestion">
                                <div class="p-6 bg-slate-900 rounded-xl text-white space-y-3.5 shadow-sm">
                                    <div class="flex items-center gap-2">
                                        <div
                                            class="w-7 h-7 bg-blue-600 rounded-lg flex items-center justify-center shrink-0">
                                        ...
                                        <h4 class="text-xs font-bold uppercase tracking-wider text-blue-300">Pembahasan Soal
                                        </h4>
                                    </div>
                                    ...
                                    <div class="text-xs font-semibold text-slate-500 italic"
                                        x-show="currentQuestion && !currentQuestion.explanation">Belum ada pembahasan
                                        tertulis untuk soal ini.</div>
                                </div>
                            </div>
                        </div>
                    </div>
