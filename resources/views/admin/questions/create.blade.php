...
<div class="max-w-7xl mx-auto" x-data="questionForm()">
    ...
    <div class="mb-6 flex items-center justify-between">
        <a href="{{ route('admin.questions.index') }}" class="inline-flex items-center gap-2 text-xs font-semibold text-slate-500 hover:text-indigo-600 transition-colors group">
    ...
    <form action="{{ route('admin.questions.store') }}" method="POST" id="main-form" class="grid grid-cols-1 lg:grid-cols-4 gap-6" @submit="submitForm($event)" novalidate>
        @csrf
            ...
            <div class="bg-white rounded-2xl border border-slate-200/70 shadow-sm overflow-hidden transition-all duration-300"
                ...
                <div class="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/40">
                    <div class="flex items-center gap-3.5">
                        ...
                        <div>
                            <h3 class="text-sm font-semibold text-slate-800 tracking-tight">Konten Utama Soal <span class="text-red-500">*</span></h3>
                            <p class="text-xs text-slate-400 mt-0.5">Tuliskan pertanyaan atau stimulus soal secara lengkap</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
