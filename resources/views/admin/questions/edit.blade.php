...
<div class="max-w-7xl mx-auto" x-data="questionForm()">
    ...
    <form action="{{ route('admin.questions.update', $question) }}" method="POST" id="main-form" class="grid grid-cols-1 lg:grid-cols-4 gap-8" @submit="submitForm($event)" novalidate>
        @csrf @method('PUT')
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden transition-all hover:shadow-md"
                ...
                <div class="p-6 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-sm font-black text-slate-800 tracking-tight">Perbarui Konten Soal <span class="text-red-500">*</span></h3>
                            <p class="text-[10px] text-slate-400 font-bold">ID Soal: #{{ $question->id }}</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden transition-all hover:shadow-md">
                <div class="p-6 border-b border-slate-50 flex items-center gap-3 bg-slate-50/30">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-400 font-bold">Informasi kunci untuk siswa</p>
                    </div>
                </div>
                <div class="p-6">
                    <div class="rounded-2xl border border-slate-100 overflow-hidden bg-slate-50/50 focus-within:ring-4 focus-within:ring-indigo-50 focus-within:border-indigo-200 transition-all">
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden sticky top-8">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                            <label class="text-[11px] font-bold text-slate-505 ml-1">Poin Benar</label>
                        ...
                        <div class="space-y-2">
                            <label class="text-[11px] font-bold text-slate-505 ml-1">Poin Salah</label>
