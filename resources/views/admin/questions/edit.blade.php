...
@section('content')
    <div class="max-w-7xl mx-auto" x-data="questionForm()">
        ...
        <form action="{{ route('admin.questions.update', $question) }}" method="POST" id="main-form"
                ...
                <div class="bg-white rounded-2xl border border-slate-200/70 shadow-sm overflow-hidden transition-all duration-300"
                    ...
                    <div class="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/40">
                        <div class="flex items-center gap-3.5">
                            ...
                            <div>
                                <h3 class="text-sm font-semibold text-slate-800 tracking-tight">Perbarui Konten Soal <span
                    ...
                    <div class="p-6">
                        <div
                            ...
                            <textarea name="content" id="editor-main"
                                class="hidden">{{ old('content', $question->content) }}</textarea>
                        </div>
                                            ...
                                            <div class="flex-grow max-w-[calc(100%-110px)]">
                                                <div
                                                    ...
                                                    <textarea :id="`editor-opt-${option.id}`"
                                                        ...
                                                        x-init="initSummernoteOption($el, index)" class="hidden"
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div
                                                    ...
                                                    <textarea :name="`match_options[${index}][left]`"
                                                        x-init="initSummernoteMatch($el, index, 'left')" class="hidden"
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div
                                                    ...
                                                    <textarea :name="`match_options[${index}][right]`"
                                                        x-init="initSummernoteMatch($el, index, 'right')" class="hidden"
                    ...
                    <div class="p-6">
                        <div
                            ...
                            <textarea name="explanation" id="editor-explanation"
                                class="hidden">{{ old('explanation', $question->explanation) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
