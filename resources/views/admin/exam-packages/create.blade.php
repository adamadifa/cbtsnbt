...
<div class="max-w-6xl mx-auto" x-data="packageForm()">
    <form action="{{ route('admin.exam-packages.store') }}" method="POST" enctype="multipart/form-data" @submit="submitForm($event)" novalidate>
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <a href="{{ route('admin.exam-packages.index') }}" class="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-orange-600 transition-colors mb-2 group">
                    <i class="ti ti-arrow-left text-sm transition-transform group-hover:-translate-x-1"></i>
            ...
            <div class="flex items-center gap-3">
                <button type="submit" class="px-5 py-2.5 bg-orange-500 hover:bg-orange-600 text-white rounded-xl text-xs font-bold transition-all flex items-center gap-2 shadow-md shadow-orange-500/20 active:scale-[0.98]">
            ...
            <div class="lg:col-span-3 space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden transition-all hover:shadow-md"
                    ...
                    <div class="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                        ...
                        <button type="button" @click="addSubtest()" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-orange-50 text-orange-600 hover:bg-orange-100 rounded-xl text-xs font-bold transition-all group">
                            <i class="ti ti-plus text-sm group-hover:rotate-90 transition-transform duration-300"></i>
                            Tambah Subtest
                        </button>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        <template x-for="(subtest, index) in subtests" :key="subtest.id">
                            <div class="p-4 rounded-xl border border-slate-100 bg-slate-50/30 flex flex-col md:flex-row md:items-center gap-4 transition-all hover:bg-white hover:border-blue-200 group shadow-sm relative"
                                ...
                                <div class="flex-grow grid grid-cols-1 md:grid-cols-4 gap-4">
                                    <!-- Subject -->
                                    <div class="group relative border border-slate-200 focus-within:border-orange-500 rounded-xl px-2.5 py-1 bg-white md:col-span-2">
                                        <label class="absolute -top-2 left-2 px-1 bg-white text-[8px] font-extrabold text-slate-400 group-focus-within:text-orange-600">Materi Uji</label>
                                    ...
                                    <!-- Duration -->
                                    <div class="group relative border border-slate-200 focus-within:border-orange-500 rounded-xl px-2.5 py-1 bg-white">
                                        <label class="absolute -top-2 left-2 px-1 bg-white text-[8px] font-extrabold text-slate-400 group-focus-within:text-orange-600">Durasi (Menit)</label>
                                    ...
                                    <!-- Questions count -->
                                    <div class="group relative border border-slate-200 focus-within:border-orange-500 rounded-xl px-2.5 py-1 bg-white">
                                        <label class="absolute -top-2 left-2 px-1 bg-white text-[8px] font-extrabold text-slate-400 group-focus-within:text-orange-600">Jumlah Soal</label>
                        ...
                        <div class="pt-4 border-t border-slate-100 flex items-center justify-end">
                            <button type="button" @click="addSubtest()" class="inline-flex items-center gap-1.5 text-xs font-bold text-orange-600 hover:text-orange-700 transition-colors group">
                                <i class="ti ti-plus text-sm group-hover:scale-125 transition-transform"></i>
                                Tambah Subtest
                            </button>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden sticky top-8">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <label class="relative cursor-pointer">
                                    ...
                                    <div class="p-3 border-2 border-slate-200 rounded-xl text-center peer-checked:border-orange-500 peer-checked:bg-orange-50/50 transition-all flex flex-col items-center gap-1">
                                        <i class="ti ti-gift text-lg text-slate-400 peer-checked:text-orange-600"></i>
                                ...
                                <label class="relative cursor-pointer">
                                    ...
                                    <div class="p-3 border-2 border-slate-200 rounded-xl text-center peer-checked:border-orange-500 peer-checked:bg-orange-50/50 transition-all flex flex-col items-center gap-1">
                                        <i class="ti ti-crown text-lg text-slate-400 peer-checked:text-orange-600"></i>
                            ...
                            <div x-show="packageType === 'premium'" x-transition class="relative">
                                <div class="group border border-slate-200 focus-within:border-orange-500 focus-within:ring-2 focus-within:ring-orange-100/50 rounded-xl px-3 py-1.5 flex items-center gap-2 bg-white">
                        ...
                        <div class="pt-5 border-t border-slate-100 space-y-2.5">
                            <button type="submit" class="w-full py-2.5 bg-orange-500 hover:bg-orange-600 text-white rounded-xl text-xs font-bold uppercase tracking-wider shadow-md shadow-orange-500/20 active:scale-[0.98] transition-all flex items-center justify-center gap-1.5">
                                <i class="ti ti-device-floppy text-base"></i>
                                Simpan Paket
                            </button>
